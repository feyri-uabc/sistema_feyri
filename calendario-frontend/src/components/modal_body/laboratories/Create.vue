<template>
    <div class="labs-modal">
        ...
        <div class="form-control w-full pb-4">
            ...
            <input @keyup="changeIsValid" autocomplete="off" spellcheck="false" v-model="current_description" type="text" placeholder="Descripcion del laboratorio" class="input input-bordered w-full">
        </div>
